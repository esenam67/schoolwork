    ...
    <div class="aboutayofitness" >
       ...
       <section class="ayopic">
         <div class="piccontainer">
           <img src="./boon/images/pexels-mart-production-8846204.jpg" alt="">
         </div>
       ...
       <div class="ourprograms">
         <h1>argentina kafa</h1>
         <p> 
              <ul class="liststy">
            <li> <a href="#" class="linkssty">contact</a> </li>
            <li><a href="#" class="linkssty">email</a></li>
            <li>speciality: ABS work</li>
           </ul></p>
       </div>
       
       
       <div class="piccontainer" style="margin-top: 0;">
        <img src="./boon/images/pexels-pixabay-416778.jpg" alt="">
      </div>
