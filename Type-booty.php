...
<div class="menu-links">
  ...
  <main class="main-body">
    ...
    <h1 class="helloworld">booty workouts</h1>

    <section class="bigcontainer">
    
    
    <arcticle class="singlecont">
    <video src="./boon/images/Espaço_Funcional_Naval_Viva_Mais.webm" controls></video>
    </arcticle>
    
    <arcticle class="singlecont">
      <video src="./boon/images/Espaço_Funcional_Naval_Viva_Mais.webm" controls class="firstvideo"></video>
      </arcticle>
