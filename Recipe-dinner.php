...
<div class="menu-links">
  ...
  <main class="main-body">
    ...
    <div class="titlerecip">
      <h2 class="recipestitle">check these dinner recipes</h2></div>
     ...
     <section class="foodtype">
      ...
      <div class="box">
        <img src="./boon/recipes/dinner/rice-g14caaae21_1920.jpg" alt="" />
        <div class="transparent-box">
          <div class="about-img">
           <a href="#" class="lnk" target="_blank"><p>rice meat</p></a>
              <p class="img-description"> cooking time: 30 min</p>
          </div>
        </div> 
      </div>
    
      <div class="box">
        <img src="./boon/recipes/dinner/rice-g7a05b6d1b_1920.jpg" alt="" />
        <div class="transparent-box">
          <div class="about-img">
           <a href="#" class="lnk" target="_blank"><p>coli rice</p></a>
    ...
    <!-- three -->
      ...
      <div class="box">
        <img src="./boon/recipes/dinner/pexels-ronmar-lacamiento-806361.jpg" alt="" />
        <div class="transparent-box">
          <div class="about-img">
           <a href="#" class="lnk" target="_blank"><p>chopped meat salad</p></a>
      ...
      <div class="box">
        <img src="./boon/recipes/dinner/beans.jpg" alt="" />
        <div class="transparent-box">
          <div class="about-img">
           <a href="#" class="lnk" target="_blank"><p>beans</p></a>
              <p class="img-description"> cooking time: 45 min</p>
          </div>
        </div> 
      </div>
