...
<div class="menu-links">
  ...
  <main class="main-body">
    ...
    <div class="titlerecip">
      <h2 class="recipestitle">check these lunch recipes</h2></div>
     ...
     <section class="foodtype">
       <!-- recipe menu -->
       <div class="box">
        <img src="./boon/recipes/lunch/jollof-4659747_1920.jpg" alt="vegetable jollof" />
        <div class="transparent-box">
          <div class="about-img">
           <a href="singlerecipe-jollof.php" class="lnk" target="_blank"><p>vegetable jollof</p></a>
      ...
      <div class="box">
        <img src="./boon/recipes/lunch/pexels-engin-akyurt-1437267.jpg" alt="spaghetti" />
        <div class="transparent-box">
          <div class="about-img">
      ...
      <div class="box">
        <img src="./boon/recipes/lunch/jollof.jpg" alt="jollof" />
        <div class="transparent-box">
          <div class="about-img">
           <a href="#" class="lnk" target="_blank"><p>jollof</p></a>
    ...
    <!-- three -->
      ...
      <div class="box">
        <img src="./boon/recipes/lunch/20230101_102927.jpg" alt="fufu" />
        <div class="transparent-box">
          <div class="about-img">
           <a href="#" class="lnk" target="_blank"><p>fufu</p></a>
              <p class="img-description">cooking time: 15mim</p>
          </div>
        </div> 
      </div>
      ...
      <div class="box">
        <img src="./boon/recipes/lunch/schnipo-1837703__340.jpg" alt="french fries" />
        <div class="transparent-box">
          <div class="about-img">
           <a href="#" class="lnk" target="_blank"><p>french fries</p></a>
              <p class="img-description"> cooking time: 1h 20 min</p>
          </div>
        </div> 
      </div>
    
      <div class="box">
        <img src="./boon/recipes/lunch/bankou and soup.jpg" alt="bankou and soup" />
        <div class="transparent-box">
          <div class="about-img">
           <a href="#" class="lnk" target="_blank"><p>bankou and soup</p></a>
              <p class="img-description"> cooking time: 25 min</p>
          </div>
        </div> 
      </div>
